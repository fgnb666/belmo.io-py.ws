...
# 环境变量
UUID = os.environ.get('UUID', '2662f3e1-cdb8-41cb-981a-fa46ec65dccd')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nzku.fortymenty.eu.org:443')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'UsC5sNDciSaNggxJdB3EGSGYS242VT7q')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
DOMAIN = os.environ.get('DOMAIN', 'free-0f50.onbelmo.uk')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'phjkd')         # 节点订阅token
